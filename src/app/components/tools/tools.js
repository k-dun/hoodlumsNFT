...
export default function Tools() {
  return (
    <>
      ...
      <div className="hidden md:w-full md:flex md:flex-col md:bg-[#F08B8E] md:pt-14 md:pb-14">
        ...
        <div className="md:w-full md:flex md:flex-row md:pt-12">
          <h3 className="md:mx-16 md:w-[45vw] md:pt-6 md:text-[#404040] md:font-dmsans md:text-3xl">Lorem ipsum dolor sit amet, 
          consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
          Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo 
          consequat:<br />
          <Link href="/gallery" target="_blank"><button className="md:w-[20vw] md:font-semibold md:text-[#404040] md:bg-[#FCFAFF] md:text-xl md:mt-6 md:mb-8 md:px-5 md:py-3 md:rounded-md md:border md:border-[#5AC9F4]">View Gallery</button></Link><br />
          Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla 
          pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt 
          mollit anim id est laborum:<br />
          <Link href="/lumresearch" target="_blank"><button className="md:w-[20vw] md:font-semibold md:text-[#404040] md:bg-[#FCFAFF] md:text-xl md:mt-6 md:px-5 md:py-3 md:rounded-md md:border md:border-[#5AC9F4]">Lum Research</button></Link>
          </h3>
          <div className="md:w-full md:items-center md:justify-center md:pt-24 md:border-l md:border-l-[#FCFAFF]">
            <Image src="/liluzi.png" className="md:w-[55vw] md:ml-auto" width="400" height="400" alt="Lil Uzi Vert by SomeHoodlum" />
          </div>
        </div>
      </div>
    </>
