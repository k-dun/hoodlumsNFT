...
export default function About() {
  return (
    <>
      <div className="md:hidden w-full min-h-[100svh] flex flex-col bg-[#5AC9F4] pt-14">
      ...
      <div className="md:w-full md:min-h-[100vh] md:flex md:flex-col md:items-center md:bg-[#5ac9f4] md:pt-14">
        <h2 className="md:mx-auto md:text-[#FCFAFF] md:font-marker md:text-6xl" id="about">ABOUT</h2>
        <h3 className="md:w-[70vw] md:pt-12 md:text-[#404040] md:font-dmsans md:text-lg">Lorem ipsum dolor sit amet, 
          consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
          Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo 
          consequat. <br /><br />
          Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla 
