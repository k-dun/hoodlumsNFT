        ...
        <div className="lg:w-[60vw] lg:mx-auto">
          ...
          <div className="w-[80vw] lg:w-[40vw] flex mx-auto justify-center pt-10 pb-6 border-b-2 border-t-2 lg:border-none border-[#FCFAFF]">
            <div className="lg:hidden flex flex-wrap justify-center">
              <Link href="#" onClick={(e) => { e.preventDefault(); onNavClick('mobileAbout')}} scroll={false}><button className="w-[34svw] lg:w-[30vw] font-semibold text-[#303030] bg-[#FCFAFF] text-base md:text-xl px-5 py-3 rounded-md border border-[#5AC9F4] mb-4 mx-2">About</button></Link>
              <Link href="#" onClick={(e) => { e.preventDefault(); onNavClick('mobileLumDAO')}} scroll={false}><button className="w-[34svw] lg:w-[30vw] font-semibold text-[#303030] bg-[#FCFAFF] text-base md:text-xl px-5 py-3 rounded-md border border-[#5AC9F4] mb-4 mx-2">LumDAO</button></Link>
              <Link href="#" onClick={(e) => { e.preventDefault(); onNavClick('mobileTeam')}} scroll={false}><button className="w-[34svw] lg:w-[30vw] font-semibold text-[#303030] bg-[#FCFAFF] text-base md:text-xl px-5 py-3 rounded-md border border-[#5AC9F4] mb-4 mx-2">Team</button></Link>
              <Link href="#" onClick={(e) => { e.preventDefault(); onNavClick('mobileTools')}} scroll={false}><button className="w-[34svw] lg:w-[30vw] font-semibold text-[#303030] bg-[#FCFAFF] text-base md:text-xl px-5 py-3 rounded-md border border-[#5AC9F4] mb-4 mx-2">Tools</button></Link>
              <Link href="https://www.flowty.io/collection/0x427ceada271aa0b1/SturdyItems" target="_blank"><button className="w-[34svw] lg:w-[30vw] font-semibold text-[#303030] bg-[#FCFAFF] text-base md:text-xl px-5 py-3 rounded-md border border-[#5AC9F4] mb-4 mx-2">Marketplace</button></Link>
              <Link href="#" onClick={(e) => { e.preventDefault(); onNavClick('mobileSocials')}} scroll={false}><button className="w-[34svw] lg:w-[30vw] font-semibold text-[#303030] bg-[#FCFAFF] text-base md:text-xl px-5 py-3 rounded-md border border-[#5AC9F4] mb-4 mx-2">Socials</button></Link>
            </div>
