...
export default function Team() {
  return (
    <>
      ...
      <div className="hidden md:w-full md:min-h-[100svh] md:flex md:flex-col md:bg-[#67CBC3] md:pt-14 md:pb-4">
        ...
        <div className="md:w-full md:flex md:flex-row">
          <div className="md:w-[30vw] md:mx-auto md:flex md:flex-col md:bg-[#FCFAFF] md:border-2 md:rounded-lg md:border-[#FCFAFF] md:mb-4">
            ...
            <div className="md:w-full md:h-[20vh] md:bg-[#FCFAFF] md:py-6 md:px-5">
              <p className="md:text-lg md:font-semibold md:text-center md:text-[#202020]">Thirdcoaster</p>
              <p className="md:text-md md:text-[#404040] md:mt-3">Head Lum. Big Cheese. Main man. The resurrector. Man of many nicknames and only singular eye.</p>
            </div>  
            <div className="md:w-full md:h-[10vh] md:pt-6 md:flex md:flex-row md:items-center md:pl-6">
              <Image src="/team-twitter-icon.svg" width="20" height="20" alt="Thirdcoaster Twitter" />
            </div>
          </div>
          <div className="md:w-[30vw] md:mx-auto md:flex md:flex-col md:bg-[#FCFAFF] md:border-2 md:rounded-lg md:border-[#FCFAFF] md:mb-4">
