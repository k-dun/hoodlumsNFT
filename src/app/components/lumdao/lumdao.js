    ...
    <>
      <div className="lg:hidden w-full flex flex-col bg-[#9C99CB] pt-14">
        ...
        <div className="md:w-[70vw] md:mx-auto">
          <h3 className="mx-6 pt-8 text-[#404040] font-dmsans text-lg md:text-2xl">Lorem ipsum dolor sit amet, 
      ...
      <div className="hidden md:hidden lg:w-full lg:flex lg:flex-col lg:bg-[#9C99CB] lg:pt-16">
        ...
        <div className="lg:w-full lg:flex lg:flex-row lg:mt-16">
          ...
          <div className="lg:w-[40vw] lg:flex lg:flex-col lg:mx-16 lg:pb-24">
            <h3 className="lg:text-[#404040] lg:font-dmsans lg:text-3xl">Lorem ipsum dolor sit amet, 
              consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
              Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo 
              consequat. <br /><br />
              Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla 
            ...
            <Link href="/lumresearch" target="_blank"><button className="lg:w-[20vw] lg:font-semibold lg:text-[#404040] lg:bg-[#FCFAFF] lg:text-xl lg:mt-6 lg:px-5 lg:py-3 lg:rounded-md lg:border lg:border-[#5AC9F4]">LumDAO</button></Link>
          </div>
        </div>
      </div>
    </>
